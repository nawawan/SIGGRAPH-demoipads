...
void ofApp::setup() {
    ...
    movies[0].load("cardJ_omote.mov");
    movies[1].load("cardK_omote.mov");
    movies[2].load("hiyoko_omote.mp4");
    movies[3].load("northrev.mp4");
    textImages[0].load("SIGGRAPHenW.PNG");
    textImages[1].load("SIGGRAPHenY.PNG");
    keyStatus = 'n';
    nowStatus = 0;
    textIndex = 0;
    incre = 0;
