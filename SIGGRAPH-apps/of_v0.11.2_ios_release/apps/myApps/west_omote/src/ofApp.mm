...
void ofApp::setup() {
    ...
    movies[0].load("cardA_omote.mov");
    movies[1].load("card9_omote.mov");
    movies[2].load("Bdoragon_F.mp4");
    movies[3].load("westrev.mp4");
    textImages[0].load("SIGGRAPHruW.PNG");
    textImages[1].load("SIGGRAPHruY.PNG");
    keyStatus = 'n';
    nowStatus = 0;
    textIndex = 0;
    incre = 0;
